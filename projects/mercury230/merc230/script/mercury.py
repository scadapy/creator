...
def sndOpCh(netAdr,ser):
     try:
         ...
         if(reqString[0] == int(netAdr) ):
             ...
             ret = 0
         print('Send open chanel: ',[ hex(int(netAdr)),0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01 , hex(crc16Lo(dataIn)), hex(crc16Hi(dataIn)) ])
...
def getEn0(netAdr,ser):
     try:
         ...
         print('Send En Tarif Sum: ',[ int(netAdr),0x05,0x00,0x00, crc16Lo(dataIn), crc16Hi(dataIn) ])
         if(reqString[0] == int(netAdr) ):
         ...
         print ('getEn0- ',e)
     print('Get: ',Aplus, Aminus^0xFFFFFFFF,Rplus,Rminus^0xFFFFFFFF)    
...
def getEn1(netAdr,ser):
     try:
         ...
         reqString= ser.read(19)
         print('Send En Tarif 1: ',[ int(netAdr),0x05,0x00,0x01, crc16Lo(dataIn), crc16Hi(dataIn) ])
         Aplus  = int(reqString[2]<<24) + int(reqString[1]<<16) + int(reqString[4]<<8) + int(reqString[3])   
         Aminus =  int(reqString[6]<<24) + int(reqString[5]<<16) + int(reqString[8]<<8) + int(reqString[7])  
         Rplus  =  int(reqString[10]<<24) + int(reqString[9]<<16) + int(reqString[12]<<8) + int(reqString[11])  
         Rminus  =  int(reqString[14]<<24) + int(reqString[13]<<16) + int(reqString[16]<<8) + int(reqString[15])  
...
def getEn2(netAdr,ser):
     try:
         ...
         reqString= ser.read(19)
         print('Send En Tarif 2: ',[ int(netAdr),0x05,0x00,0x02, crc16Lo(dataIn), crc16Hi(dataIn) ])         
         Aplus  = int(reqString[2]<<24) + int(reqString[1]<<16) + int(reqString[4]<<8) + int(reqString[3])   
         Aminus =  int(reqString[6]<<24) + int(reqString[5]<<16) + int(reqString[8]<<8) + int(reqString[7])  
         Rplus  =  int(reqString[10]<<24) + int(reqString[9]<<16) + int(reqString[12]<<8) + int(reqString[11])  
         Rminus  =  int(reqString[14]<<24) + int(reqString[13]<<16) + int(reqString[16]<<8) + int(reqString[15])  
...
def getEn3(netAdr,ser):
     try:
         ...
         reqString= ser.read(19)
         print('Send En Tarif 3: ',[ int(netAdr),0x05,0x00,0x03, crc16Lo(dataIn), crc16Hi(dataIn) ])         
         Aplus  = int(reqString[2]<<24) + int(reqString[1]<<16) + int(reqString[4]<<8) + int(reqString[3])   
         Aminus =  int(reqString[6]<<24) + int(reqString[5]<<16) + int(reqString[8]<<8) + int(reqString[7])  
         Rplus  =  int(reqString[10]<<24) + int(reqString[9]<<16) + int(reqString[12]<<8) + int(reqString[11])  
         Rminus  =  int(reqString[14]<<24) + int(reqString[13]<<16) + int(reqString[16]<<8) + int(reqString[15])  
...
def getEn4(netAdr,ser):
     try:
         ...
         reqString= ser.read(19)
         print('Send En Tarif 4: ',[ int(netAdr),0x05,0x00,0x04, crc16Lo(dataIn), crc16Hi(dataIn) ])          
         Aplus  = int(reqString[2]<<24) + int(reqString[1]<<16) + int(reqString[4]<<8) + int(reqString[3])   
         Aminus =  int(reqString[6]<<24) + int(reqString[5]<<16) + int(reqString[8]<<8) + int(reqString[7])  
         Rplus  =  int(reqString[10]<<24) + int(reqString[9]<<16) + int(reqString[12]<<8) + int(reqString[11])  
         Rminus  =  int(reqString[14]<<24) + int(reqString[13]<<16) + int(reqString[16]<<8) + int(reqString[15])  
...
def getConnect(netAdr,ser):
     try:
         ...
         reqString= ser.read(4)
         print('---------------------------------------------------')
         print('Try connect: ',[ hex(int(netAdr)), 0x00 , hex(crc16Lo(dataIn)), hex(crc16Hi(dataIn)) ])
         if(reqString[0] == int(netAdr) ):
             ret = 1
         else: 
             ret = 0
...
def getU(netAdr,ser):
     try:
         ...
         print('Send U: ',[ int(netAdr),0x08,0x16,0x11, crc16Lo(dataIn), crc16Hi(dataIn) ])
...
def getI(netAdr,ser):
     try:
         ...
         reqString= ser.read(12)
         print('Send I: ',[ int(netAdr),0x08,0x16,0x21, crc16Lo(dataIn), crc16Hi(dataIn) ])
...
def getP(netAdr,ser):
     try:
         ...
         print('Send P: ',[ int(netAdr),0x08,0x16,0x00, crc16Lo(dataIn), crc16Hi(dataIn) ])
...
def getPS(netAdr,ser):
     try:
         ...
         reqString= ser.read(15)
         print('Send S',[ int(netAdr),0x08,0x16,0x08, crc16Lo(dataIn), crc16Hi(dataIn) ])
         bt1=str(bin(reqString[1]))[2:].zfill(8) 
         bt4=str(bin(reqString[4]))[2:].zfill(8) 
         bt7=str(bin(reqString[7]))[2:].zfill(8) 
         bt10=str(bin(reqString[10]))[2:].zfill(8) 
...
def getPQ(netAdr,ser):
     try:
         ...
         reqString= ser.read(15)
         print('Send Q: ',[ int(netAdr),0x08,0x16,0x04, crc16Lo(dataIn), crc16Hi(dataIn) ])
         bt1=str(bin(reqString[1]))[2:].zfill(8) 
         bt4=str(bin(reqString[4]))[2:].zfill(8) 
         bt7=str(bin(reqString[7]))[2:].zfill(8) 
         bt10=str(bin(reqString[10]))[2:].zfill(8) 
...
def getCosF(netAdr,ser):
     try:
         ...
         reqString= ser.read(15)
         print('Send cosF: ',[ int(netAdr),0x08,0x16,0x30, crc16Lo(dataIn), crc16Hi(dataIn) ])
         bt1=str(bin(reqString[1]))[2:].zfill(8) 
         bt4=str(bin(reqString[4]))[2:].zfill(8) 
         bt7=str(bin(reqString[7]))[2:].zfill(8) 
         bt10=str(bin(reqString[10]))[2:].zfill(8) 
...
def getAngle(netAdr,ser):
     try:
         ...
         reqString= ser.read(12)
         print('Send Angl: ',[ hex(int(netAdr)),hex(0x08),hex(0x16),hex(0x51), hex(crc16Lo(dataIn)), hex(crc16Hi(dataIn)) ])
         ...
         print ('getAng- ',e) 
     print('Get: ',A1^0xFFFFFF,A2^0xFFFFFF,A3^0xFFFFFF)    
...
def getFreq(netAdr,ser):
     try:
         ...
         print('Send freq: ',[ hex(int(netAdr)),hex(0x08),hex(0x16),hex(0x40), hex(crc16Lo(dataIn)), hex(crc16Hi(dataIn)) ])
         if(reqString[0] == int(netAdr) ):
...
def getSN(netAdr,ser):
     try:
         ...
         reqString= ser.read(6)
         print('Get serial: ',[ hex(int(netAdr)),hex(0x08),hex(0x00), hex(crc16Lo(dataIn)), hex(crc16Hi(dataIn)) ])
