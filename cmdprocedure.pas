...
procedure StartCommandW(pyfile: string);
...
begin
 ...
 //StringReplace(scadapy.ProjectPath,'python','pythonw',[rfReplaceAll])+'tkrun.pyw');

procedure StartCommandW(pyfile: string);
begin
       {$IFDEF Windows}
          RunCmd(StringReplace(scadapy.PathToPythonWindows,'python','pythonw',[rfReplaceAll])+' '+scadapy.ProjectPath+pyfile+'"');
