# -*- coding: utf-8 -*-
###########################################################################
## Python code generated with ScadaPy Creator v.3.2.9  29-4-18 
...
def Proc_5(f=1):
     ...
     for i in range(0,unitCount+1):
         ...
         timeOut.append(i)
     try:
         com=serial.Serial('/dev/ttyUSB1',9600, timeout=2, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, bytesize=serial.EIGHTBITS)
         time.sleep(2) 
