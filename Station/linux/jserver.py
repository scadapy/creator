...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'merc_230_81','Aminus_81','3','1','1','integer','0.001')
         if(x!=None):
             Aminus_81=x
         else:
             Aminus_81=Aminus_81
...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'merc_230_81','Rplus_81','4','1','1','integer','0.001')
         if(x!=None):
             Rplus_81=x
         else:
             Rplus_81=Rplus_81
...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'merc_230_81','Rminus_81','5','1','1','integer','0.001')
         if(x!=None):
             Rminus_81=x
         else:
             Rminus_81=Rminus_81
...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'merc_230_43','Aplus_43','2','1','1','integer','0.001')
         if(x!=None):
             Aplus_43=x
         else:
             Aplus_43=Aplus_43
...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'merc_230_43','Aminus_43','3','1','1','integer','0.001')
         if(x!=None):
             Aminus_43=x
         else:
             Aminus_43=Aminus_43
...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'Generator_TC','Gen_ON_OFF','0','1','1','bool','1')
         if(x!=None):
             Gen_ON_OFF=x
         else:
             Gen_ON_OFF=Gen_ON_OFF
     except Exception as e:
         pass
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'Generator_TC','Gen_Overload','1','1','1','bool','1')
         if(x!=None):
             Gen_Overload=x
         else:
             Gen_Overload=Gen_Overload
     except Exception as e:
         pass
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'Generator_TC','Gen_Def','2','1','1','bool','1')
         if(x!=None):
             Gen_Def=x
         else:
             Gen_Def=Gen_Def
...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'Generator_TC','Gen_Fuel','3','1','1','bool','1')
         if(x!=None):
             Gen_Fuel=x
         else:
             Gen_Fuel=Gen_Fuel
...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'Generator_TC','Gen_Temp','4','1','1','bool','1')
         if(x!=None):
             Gen_Temp=x
         else:
             Gen_Temp=Gen_Temp
...
#-----------------------------------------------------------------------------------
     try:
         x=getVariables(getData,'Generator_TC','Gen_Pression','5','1','1','bool','1')
         if(x!=None):
             Gen_Pression=x
         else:
             Gen_Pression=Gen_Pression
     except Exception as e:
         pass
#-----------------------------------------------------------------------------------
